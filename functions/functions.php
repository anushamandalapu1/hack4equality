...
<div class = 'product-price'>
  ...
  <div class = 'right'> 
  <p class='' >$product_price  $product_psp_price</p>
...
function getRecycledProducts()
{
  ...
  $get_products = "select * from recycled_products  " . $sWhere;
  ...
  /// getRecycledProducts function Code Ends ///
