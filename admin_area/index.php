...
//testing our insert recycled_p

if(isset($_GET['recycled_product'])){

include("recycled_product.php");
...
//view recycled_products testing


if(isset($_GET['viewRecycled_products'])){

include("viewRecycled_products.php");
